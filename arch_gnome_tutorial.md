...
This is an **OPINIONATED** Arch installation guide for regular folks who just want a working system to game on that's straight forward with GNOME
...
all of them are in my opinion essential to the well functioning of a GNOME desktop except for kitty and pkgstats. 
...
pacman -S --needed \
  ...
  gdm nautilus gnome-keyring gnome-terminal kitty gvfs gnome-control-center \
...
Head to `arch_gnome_post_tutorial.md` to do the post-install tutorial.
