...
The report state that a regression of at leas **50%(!)** is standard. According to some of the comments in the thread your mileage may vary depending on your hardware however, but a regression seems to unfortunately be a guarantee. Make up your own mind if this is worth it for you, however if your device will be easily accessible to the public I strongly urge at least trying LUKS regardless of the trade offs mentioned.
