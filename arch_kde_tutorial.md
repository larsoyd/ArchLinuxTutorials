...
This is an optional but highly recommended tweak which enables all the Magic SysRq functions needed for **REISUB.** Here is what it is, how to use it, and why you should want to enable it despite the risks:
