...
- Every step except for one is the same, but if this is your first time **I strongly recommend not doing this**. This is **only** if you already have a gist on how to install Arch and you don't want to use the TUI.
